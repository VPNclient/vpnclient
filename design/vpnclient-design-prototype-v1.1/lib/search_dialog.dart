...
class _SearchDialogState extends State<SearchDialog> {
  ...
  // Drag-to-close: per Figma, the modal can be dismissed at any time by
            ...
            children: [
              GestureDetector(
                ...
                onVerticalDragEnd: (details) {
                  final shouldClose =
                      _dragOffset > 100 || (details.primaryVelocity ?? 0) > 800;
                  setState(() {
                    _isDragging = false;
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: const TextStyle(color: AppColors.fg2),
                    suffixIcon: Icon(
                      Icons.search,
                      color: Theme.of(context).colorScheme.primary,
                    ),
