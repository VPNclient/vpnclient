...
const _euMethods = ['Карта евро', 'QR евро'];
const _otherMethods = ['Криптовалюта', 'Telegram Stars'];
...
class _SubscribeSheetState extends State<SubscribeSheet> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: selected ? const Color(0xFFEA7500) : Colors.transparent,
            width: 2,
          ),
          boxShadow: const [
            BoxShadow(color: Color(0x1A9CB2C2), blurRadius: 32, offset: Offset(0, 1)),
              ...
              child: Row(
                children: [
                  Icon(
                    ...
                    color: _promoApplied ? const Color(0xFFEA7500) : _muted,
                  ),
                  const SizedBox(width: 8),
                  const Expanded(
                    child: Text(
  ...
  Widget _methodPage() {
    Widget group(String title, List<String> methods) => Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
            ...
            child: Padding(
              ...
              child: _card(
                child: Row(
                  children: [
                    Expanded(
                      child: Text(m, style: const TextStyle(fontSize: 17, color: _primaryText)),
                    ),
                    if (_paymentMethod == m)
                      const Icon(Icons.check, color: Color(0xFFEA7500)),
                  ],
                ),
              ),
            ),
              ...
              child: Row(
                children: [
                  Icon(
                    ...
                    color: _autopay ? const Color(0xFFEA7500) : _muted,
                  ),
                  const SizedBox(width: 8),
                  const Expanded(
                    child: Text(
