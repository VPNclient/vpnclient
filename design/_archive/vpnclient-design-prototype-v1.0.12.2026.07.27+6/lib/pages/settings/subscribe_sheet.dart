...
const _ruMethods = [
  ('Карта рубли', null),
  ('МИР', 'assets/images/payment/mir.svg'),
  ('СБП', 'assets/images/payment/sbp.svg'),
  ('Sber Pay', null),
  ('T-Bank Pay', null),
  ('ЮMoney', null),
  ('QR-код рубли', null),
...
const _euMethods = [
  ('Карта евро', 'assets/images/payment/visa.svg'),
  ('QR евро', null),
];
const _otherMethods = [
  ('Криптовалюта', 'assets/images/payment/crypto.svg'),
  ('Telegram Stars', null),
];
